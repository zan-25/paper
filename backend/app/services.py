...
class GeminiService:
    ...
    def extract_questions_from_image(
        ...
        system = "You are using Gemini to extract exam questions from uploaded source material."
...
def parse_uploaded_document(
    ...
    ai_mode = "heuristic"
    if suffix in {".png", ".jpg", ".jpeg"}:
        extracted = gemini_service.extract_questions_from_image(content)
        ...
        extracted = gemini_service.extract_questions_from_text(parsed_text)
